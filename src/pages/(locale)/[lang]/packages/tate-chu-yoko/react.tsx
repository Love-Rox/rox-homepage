...
import langJa from "@private/lang/pages/ja/packages/tate-chu-yoko/react.json";
...
export default async function TateChuYokoReactPage({
  lang,
}: PageProps<"/[lang]/packages/tate-chu-yoko/react">) {
  const locale = (lang as Locale) || "en";
  const content = langData[locale];
  const landing = landingData[locale];
  const url = `/${locale}/packages/tate-chu-yoko/react`;
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 pt-24">
      ...
      <div className="max-w-5xl mx-auto">
        <AdapterNav current="react" locale={locale} />
        ...
        <Section heading={content.usage.heading}>
          ...
          <SnippetBlock label={content.usage.snippetLabel} code={reactSnippet} language="tsx" />
        </Section>
