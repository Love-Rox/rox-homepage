...
- **デプロイメントの柔軟性**: DockerでVPSに、またはベアメタルで直接インストール
...
RoxはAGPL-3.0（GNU Affero General Public License v3）の下でオープンソースソフトウェアとして公開されています。このライセンスは、ネットワーク経由でサービスを提供する場合でも、改変したソースコードを公開する義務があるコピーレフトライセンスです。
...
| 日付 | 変更内容 |
|------|----------|
| 2025-12-12 | ライセンス情報をMITからAGPL-3.0に修正 |
| 2025-12-10 | Cloudflare Workers/エッジデプロイメント参照を削除（開発中止） |
