...
4. 自動セットアップ完了後、`bun run dev` で開発開始

詳細は[はじめにガイド](getting-started)をご覧ください。
...
貢献することで、あなたの貢献がプロジェクトの[AGPL-3.0ライセンス](https://github.com/Love-Rox/rox/blob/main/LICENSE)の下でライセンスされることに同意したことになります。
...
| 日付 | 変更内容 |
|------|----------|
| 2025-12-12 | DevContainerオプションを追加、ライセンス表記をAGPL-3.0に修正 |
