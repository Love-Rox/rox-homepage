...
faq:
  - question: プラグインシステムとは何ですか？
    answer: Roxの機能を開発者が自由に拡張できるようにするための基盤システムです。UIの追加やイベントのフックが可能です。
  - question: 既存のMisskeyクライアントは使えますか？
    answer: はい、Misskey API互換性を維持しているため、既存のMisskeyクライアントの多くが利用可能です。
---
